...
// RatingHandler defines a HTTP rating handler.
type RatingHandler struct {
	ctrl *rating.RatingController
}

// NewRatingHandler creates a new rating service HTTP handler.
func NewRatingHandler(ctrl *rating.RatingController) *RatingHandler {
	return &RatingHandler{ctrl}
}
